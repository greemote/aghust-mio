...
prepareData.m should be used to generate the proper matrix from the .csv file for the net, but it takes a lot of time - better use already created data stored in preppedData.mat  
